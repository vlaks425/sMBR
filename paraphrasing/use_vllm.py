...
output_file_path="/raid/lyu/QEBT/en2de/wmt2020.en2de.mixtral-8x7b-instruct-v0.1.4b-vllm-v0.0.1"
...
for i in range(len(outputs)):
    ...
    if is_output_valid(generated_text):
        ...
        while True:
            ...
            outputs = llm.generate([inputs[i]], sampling_params=sampling_params,prefix_pos=[len(prompt)])
            if is_output_valid(generated_text):
                results.append({"original":prompt,"paraphrase":generated_text})
                break
