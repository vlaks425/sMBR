        ...
        for line,line2 in tqdm(zip(lines,lines2),total=len(lines)):
            if line and line2:
                ...
                if en_len>200 or zh_len>200:
                    continue
                if en_len<2 or zh_len<2:
                    continue
                if en_len/len_ja>1.8 or len_ja/len_en>1.8:
                    continue
...
with open(output_path+"/train.ja", "w", encoding="utf-8") as fout, open(output_path+"/train.en", "w", encoding="utf-8") as fout2:
