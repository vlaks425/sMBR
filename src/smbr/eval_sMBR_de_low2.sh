...
# 定义一个包含不同 k 值的数组
k_values=(5 16 32 64 80 96)
#k_values=(128 160 200 240 280 320 340 400)
# 遍历 k 值
for k in "${k_values[@]}"
do
  echo "start $k"
  output_prefix=/raid/lyu/QEBT/test_dev/test_en2de_low/sMBR_$decoding_method/output_$k
  baseline_prefix=/raid/lyu/QEBT/test_dev/test_en2de_low/$decoding_method/$k
  qe_prefix=/raid/lyu/QEBT/test_dev/test_en2de_low/qe_$decoding_method/output_$k
  mbr_prefix=/raid/lyu/QEBT/test_dev/test_en2de_low/mbr_$decoding_method/output_$k
  ...
  python /home/lr/lyu/QEBT/src/filter4sMBR.py --input_file $qe_prefix/qe.output.score --output_file $new_qe_prefix/qe.output.score --phrasing_file $phrasing_file --original_file /raid/lyu/QEBT/en2de/wmt2020.en --k_input $k
  ...
  bash /home/lr/lyu/QEBT/src/eval_de.sh $src_file.filter $tgt_file.filter $output_prefix/hypo_1 $new_baseline_prefix $cuda_devices
  python /home/lr/lyu/QEBT/src/filter4sMBR.py --input_file $qe_prefix/qe.output --output_file $new_qe_prefix/qe.output.filter --phrasing_file $phrasing_file --original_file /raid/lyu/QEBT/en2de/wmt2020.en --k_input 1
  bash /home/lr/lyu/QEBT/src/eval_de.sh $src_file.filter $tgt_file.filter $new_qe_prefix/qe.output.filter $new_qe_prefix $cuda_devices
  new_mbr_prefix=$output_prefix/mbr_baseline
  mkdir -p $new_mbr_prefix
  python /home/lr/lyu/QEBT/src/filter4sMBR.py --input_file $mbr_prefix/mbr.output --output_file $new_mbr_prefix/mbr.output.filter --phrasing_file $phrasing_file --original_file /raid/lyu/QEBT/en2de/wmt2020.en --k_input 1
  python /home/lr/lyu/QEBT/src/filter4sMBR.py --input_file $mbr_prefix/mbr.score --output_file $new_mbr_prefix/mbr.score --phrasing_file $phrasing_file --original_file /raid/lyu/QEBT/en2de/wmt2020.en --k_input 1
  bash /home/lr/lyu/QEBT/src/eval_de.sh $src_file.filter $tgt_file.filter $new_mbr_prefix/mbr.output.filter $new_mbr_prefix $cuda_devices
  echo "done $k"
