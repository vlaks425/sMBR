set -e
src_num=5
phrasing_file=/raid/lyu/QEBT/en2de/wmt2020.en2de.gpt-3.5-turbo-0125.json
...
do
  echo "start $k"
  output_prefix=/raid/lyu/QEBT/test_dev/test_en2de/sMBR_gpt3.5-0125_mean_$decoding_method/output_$k
