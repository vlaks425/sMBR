...
do
  echo "start $k"
  output_prefix=/raid/lyu/QEBT/test_dev/test_en2ru/sMBR_bt_$decoding_method/output_$k
  ...
  python /home/lr/lyu/QEBT/src/compute_sMBR_score.py --qe_score_file $qe_prefix/qe.output.score --phrasing_qe_score_file $output_prefix/phrasing.score --output_file $output_prefix/sMBR.output --hypo_file $baseline_prefix/hypo_$k --k $k
