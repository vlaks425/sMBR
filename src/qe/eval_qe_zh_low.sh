...
# 定义一个包含不同 k 值的数组
k_values=(160 128 96 80 64 32 16 5)

# 遍历 k 值
for k in "${k_values[@]}"
do
  output_prefix=/raid/lyu/QEBT/test_dev/test/qe_$decoding_method/output_$k
  baseline_prefix=/raid/lyu/QEBT/test_dev/test/$decoding_method/$k
