...
do
  echo "start $k"
  output_prefix=/raid/lyu/QEBT/test_dev/test_en2de/qe_$decoding_method/output_$k
...
do
  ...
  output_prefix=/raid/lyu/QEBT/test_dev/test_en2de/qe_$decoding_method/output_$k
  baseline_prefix=/raid/lyu/QEBT/test_dev/test_en2de/$decoding_method/$k
  bash /home/lr/lyu/QEBT/src/eval_de.sh $src_file $tgt_file $output_prefix/qe.output $output_prefix 0
  bash /home/lr/lyu/QEBT/src/eval_de.sh $src_file $tgt_file $baseline_prefix/hypo_1 $baseline_prefix 0
  echo "done $k"
