...
do
    ...
    # 执行命令
    #python /home/lr/lyu/QEBT/src/ct2.py --src_file $src_file --output_file $output_prefix/ct2_output.hypo_$k --model_path $model_path --beam_size $k --num_hypotheses $k --gpu $cuda_devices
