...
CUDA_VISIBLE_DEVICES=$cuda_devices python /raid/lyu/evaluate_entity_translation/evaluate_entity_translation.py --ref_file $tgt_file --hypo_file $hypo_file --lang ru >> $output_prefix/score.log
CUDA_VISIBLE_DEVICES=$cuda_devices bert-score -r $tgt_file -c $hypo_file --idf --lang ru >> $output_prefix/score.log
