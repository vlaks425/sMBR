...
input_prefix=/raid/lyu/QEBT/en2zh/baseline/bt_news_crawl_300k_QE_hypo_5
output_prefix=$cur_path
checkpoints_dir=/cache01/lyu/checkpoints/en2zh/nc18/bt_news_crawl_300k_QE_hypo_5
mv_dir=/raid_elmo/home/lr/lyu/checkpoints/en-zh/en2zh/bt_news_crawl_300k_QE_hypo_5
mkdir -p $mv_dir
