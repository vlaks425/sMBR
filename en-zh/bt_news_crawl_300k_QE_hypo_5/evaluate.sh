...
data_prefix=/raid/lyu/QEBT/en2zh/baseline/bt_news_crawl_300k_QE_hypo_5
ref_file=/raid/lyu/en-zh/test/zh/test.zho
input_prefix=$cur_path
checkpoints_dir=/raid_elmo/home/lr/lyu/checkpoints/en-zh/en2zh/bt_news_crawl_300k_QE_hypo_5
