...
input_prefix=/raid/lyu/QEBT/zh2en/baseline
output_prefix=$cur_path
checkpoints_dir=/local/lyu/checkpoints/zh2en/nc18/baseline
mv_dir=/raid_elmo/home/lr/lyu/checkpoints/en-zh/zh2en/baseline
if [ ! -d $checkpoints_dir ]; then
    mkdir -p $checkpoints_dir
fi
CUDA_VISIBLE_DEVICES=2,3 fairseq-train $input_prefix/data-bin \
